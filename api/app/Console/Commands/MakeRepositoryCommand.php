...
use App\Console\Generators\CustomRepositoryGenerator;
use App\Console\Generators\CustomRepositoryInterfaceGenerator;
use File;
...
class MakeRepositoryCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Custom l5 make repository';
    ...
    public function fire()
    {
        ...
        $this->generators->push(new CustomRepositoryInterfaceGenerator([
            'name'  => $this->argument('name'),
            'force' => $this->option('force'),
        ]));
    ...
    private function bindings()
    {
        try {
            ...
            $this->info('Binding success');
        } catch (FileAlreadyExistsException $e) {
            $this->error('Binding failed');
